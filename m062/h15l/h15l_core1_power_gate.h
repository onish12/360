...
enum H15lFlags : ULONG {
    ...
    H15lImmediateCaptured=1u<<5,
    H15lImmediateSpa1Observed=1u<<6,
    H15lImmediateCpa1Observed=1u<<7,
    H15lAfter10usCaptured=1u<<8,
    H15lAfter10usSpa1Observed=1u<<9,
    H15lAfter10usCpa1Observed=1u<<10,
    H15lAfter100usCaptured=1u<<11,
    H15lAfter100usSpa1Observed=1u<<12,
    H15lAfter100usCpa1Observed=1u<<13,
    H15lAfter500usCaptured=1u<<14,
    H15lAfter500usSpa1Observed=1u<<15,
    H15lAfter500usCpa1Observed=1u<<16,
    H15lSpa1ClearWritten=1u<<17,
    H15lSpa1ClearObserved=1u<<18,
    H15lCpa1ClearObserved=1u<<19,
    H15lRestoredCaptured=1u<<20,
    H15lAdspcsRestoredExact=1u<<21,
    H15lNoHdaMmioWrite=1u<<22,
    H15lNoPciWrite=1u<<23,
    H15lNoDma=1u<<24,
    H15lNoIrqOwnership=1u<<25,
    H15lNoFirmware=1u<<26,
    H15lNoDspBoot=1u<<27,
    H15lNoPlayback=1u<<28,
    H15lOneShot=1u<<29,
    H15lOnlySpa1Write=1u<<30,
    H15lNoCpaWrite=1u<<31
};
...
struct H15lResultV1 {
    ...
    H15lObservation immediate;
    H15lObservation after10us;
    H15lObservation after100us;
    H15lObservation after500us;
    H15lObservation restored;
};
static_assert(sizeof(H15lResultV1)==352u,"H15L result ABI");
