...
setlocal
cd /d "%~dp0"
echo PHASER360 H15F - FUNCTION DRIVER OWNERSHIP HANDOFF / ROLLBACK
echo Necesita TESTSIGN deja permis si WinRE activ.
echo Nu modifica BCD si nu reporneste Windows.
echo Nu face MMIO, PCI write, DMA, IRQ ownership, firmware sau playback.
echo.
...
"%SystemRoot%\System32\WindowsPowerShell\v1.0\powershell.exe" -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%~dp0Run-H15fHandoff.ps1" -PackageRoot "%PHASER_PACKAGE%"
