...
static_assert(sizeof(H15jObservation)==48u,"H15J observation ABI");

enum H15jFlags : ULONG {
    H15jAttestationValid=1u<<0, H15jExpectedBaselineMatch=1u<<1, H15jBeforeCaptured=1u<<2,
    H15jCrstSetWritten=1u<<3, H15jCrstReadyObserved=1u<<4, H15jReadyCaptured=1u<<5,
    H15jHdaQuiescentObserved=1u<<6, H15jCrstClearWritten=1u<<7, H15jCrstRestoredObserved=1u<<8,
    H15jRestoredCaptured=1u<<9, H15jGctlRestoredExact=1u<<10, H15jNoPciWrite=1u<<11,
    H15jNoDspMmioWrite=1u<<12, H15jNoDma=1u<<13, H15jNoIrqOwnership=1u<<14,
    H15jNoFirmware=1u<<15, H15jNoDspBoot=1u<<16, H15jOneShot=1u<<17,
    H15jSplitMappings=1u<<18, H15jNoHdaNonGctlWrite=1u<<19
};
inline constexpr ULONG kH15jRequiredFlags=0x000fffffu;
...
struct H15jResultV1 {
    ...
    ULONG hdaLength;
    ULONG dspLength;
    H15jObservation before;
    H15jObservation ready;
    H15jObservation restored;
};
