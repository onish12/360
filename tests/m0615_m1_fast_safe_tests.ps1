...
foreach($x in @(
 'm1-fast-safe-20260924-r3.1-cm-interface-fallback','EXACT_WINDOWS_BUILD_19044_REQUIRED','PCI\VEN_8086&DEV_3198&SUBSYS_00000000&REV_06',
...
foreach($x in @('-NonInteractive','Run-M1FastSafe.ps1','m1-fast-safe-20260924-r3.1-cm-interface-fallback')){if($c.IndexOf($x,[StringComparison]::OrdinalIgnoreCase)-lt0){throw "M1_FAST_CMD_MISSING:$x"}}
