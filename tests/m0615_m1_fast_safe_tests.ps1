...
foreach($x in @('-NonInteractive','Run-M1FastSafe.ps1','m1-fast-safe-20260923-r2-interface-wait')){if($c.IndexOf($x,[StringComparison]::OrdinalIgnoreCase)-lt0){throw "M1_FAST_CMD_MISSING:$x"}}
